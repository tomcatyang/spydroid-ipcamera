...
public class SpydroidApplication extends android.app.Application {
	...
	public void onCreate() {
		...
		Log.e(TAG, SessionBuilder.getInstance().hashCode()+":onSharedPreferenceChanged1111111:"+SessionBuilder.getInstance().getVideoQuality().framerate);
	...
	private OnSharedPreferenceChangeListener mOnSharedPreferenceChangeListener = new OnSharedPreferenceChangeListener() {
		...
		public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
			...
			if (key.equals("video_resX") || key.equals("video_resY")) {
				...
				Log.e(TAG, SessionBuilder.getInstance().hashCode()+":onSharedPreferenceChanged:"+SessionBuilder.getInstance().getVideoQuality().framerate);
			}
