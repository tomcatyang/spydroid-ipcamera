...
import net.majorkernelpanic.streaming.hw.EncoderDebuggerH264;
...
public class H264Stream extends VideoStream {
	...
	private MP4Config testMediaCodecAPI() throws RuntimeException, IOException {
		try {
			Log.e(TAG,"testMediaCodecAPI:"+mQuality.resX+":"+ mQuality.resY+":"+ mQuality.framerate+":"+ mQuality.bitrate);
			...
			Log.e(TAG,"EncoderDebuggerH264 debugger = EncoderDebuggerH264.debug(mSettings, "+mQuality.resX+":"+ mQuality.resY+":"+ mQuality.framerate+":"+ mQuality.bitrate);
			EncoderDebuggerH264 debugger = EncoderDebuggerH264.debug(mSettings, mQuality.resX, mQuality.resY, mQuality.framerate, mQuality.bitrate);
	...
	private MP4Config testMediaRecorderAPI() throws RuntimeException, IOException {
		...
		Log.e(TAG, "testMediaRecorderAPI key:"+key);
