...
public abstract class VideoStream extends MediaStream {
	...
	protected void encodeWithMediaCodecMethod1() throws RuntimeException, IOException {
			...
			public void onPreviewFrame(byte[] data, Camera camera) {
				...
				try {
					...
					if (bufferIndex>=0) {
						...
						EncoderDebuggerH264.swapYV12toI420(data, inputBuffers[bufferIndex], mQuality.resX, mQuality.resY);//(data, inputBuffers[bufferIndex]);
		...
		for (int i=0;i<10;i++) 
			mCamera.addCallbackBuffer(new byte[EncoderDebuggerH264.getBufferSize(mQuality.resX, mQuality.resY)]);
